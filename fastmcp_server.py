...
@server.tool(
    ...
    description=(
        ...
        "market values, FFA SOS, offensive-line rank, Vegas win totals, and optional "
        "sentiment signals."
    ),
...
async def ff_project_auction_values(
    ctx: Context,
    projection_path: str,
    ffa_projection_path: Optional[str] = None,
    ffa_custom_rankings_path: Optional[str] = None,
    fantasypros_projection_path: Optional[str] = None,
    fantasypros_qb_projection_path: Optional[str] = None,
    fantasypros_rankings_path: Optional[str] = None,
    profile_path: Optional[str] = None,
    market_values_path: Optional[str] = None,
    historical_path: Optional[str] = None,
    team_environment_path: Optional[str] = None,
    ...
    return await _call_legacy_tool(
        ...
        ffa_projection_path=ffa_projection_path,
        ffa_custom_rankings_path=ffa_custom_rankings_path,
        fantasypros_projection_path=fantasypros_projection_path,
        fantasypros_qb_projection_path=fantasypros_qb_projection_path,
        fantasypros_rankings_path=fantasypros_rankings_path,
        profile_path=profile_path,
        market_values_path=market_values_path,
        historical_path=historical_path,
        team_environment_path=team_environment_path,
        sentiment=sentiment,
        ...
        ffa_weight=ffa_weight,
        yahoo_weight=yahoo_weight,
        ffa_custom_weight=ffa_custom_weight,
        market_weight=market_weight,
        historical_weight=historical_weight,
        max_sos_adjustment=max_sos_adjustment,
        max_offensive_line_adjustment=max_offensive_line_adjustment,
        max_team_environment_adjustment=max_team_environment_adjustment,
